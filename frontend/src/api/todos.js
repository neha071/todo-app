...
export const getSubtasks = (todoId) => API.get(`/todos/${todoId}/subtasks`);
export const createSubtask = (todoId, title) => API.post(`/todos/${todoId}/subtasks`, { title });
export const deleteSubtask = (todoId, subtaskId) => API.delete(`/todos/${todoId}/subtasks/${subtaskId}`);
